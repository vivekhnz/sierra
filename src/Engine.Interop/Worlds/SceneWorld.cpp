...
namespace Terrain { namespace Engine { namespace Interop { namespace Worlds {
    ...
    void SceneWorld::initialize(uint32 heightmapTextureHandle)
    {
        ...
        isGroundAlbedoTextureLoaded = false;
        isGroundNormalTextureLoaded = false;
        isGroundDisplacementTextureLoaded = false;
        isGroundAoTextureLoaded = false;
        isRockAlbedoTextureLoaded = false;
        isRockNormalTextureLoaded = false;
        isRockDisplacementTextureLoaded = false;
        isRockAoTextureLoaded = false;
        isSnowAlbedoTextureLoaded = false;
        isSnowNormalTextureLoaded = false;
        isSnowDisplacementTextureLoaded = false;
        isSnowAoTextureLoaded = false;
    }
