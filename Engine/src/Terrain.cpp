...
Terrain::Terrain() :
    ...
    meshEdgeCount((2 * (rows * columns)) - rows - columns),
...
void Terrain::initialize(const ShaderManager &shaderManager)
{
    // load shaders
    ...
    albedoTexture.initialize(Image("data/ground_albedo.bmp", false), GL_RGB, GL_RGB,
        GL_UNSIGNED_BYTE, GL_REPEAT, GL_LINEAR_MIPMAP_LINEAR);
    normalTexture.initialize(Image("data/ground_normal.bmp", false), GL_RGB, GL_RGB,
        GL_UNSIGNED_BYTE, GL_REPEAT, GL_LINEAR_MIPMAP_LINEAR);
    displacementTexture.initialize(Image("data/ground_displacement.tga", true), GL_R16, GL_RED,
        GL_UNSIGNED_SHORT, GL_REPEAT, GL_LINEAR_MIPMAP_LINEAR);
    aoTexture.initialize(Image("data/ground_ao.tga", false), GL_R8, GL_RED, GL_UNSIGNED_BYTE,
        GL_REPEAT, GL_LINEAR_MIPMAP_LINEAR);
    roughnessTexture.initialize(Image("data/ground_roughness.tga", false), GL_R8, GL_RED,
        GL_UNSIGNED_BYTE, GL_REPEAT, GL_LINEAR_MIPMAP_LINEAR);
