...
set SRC_FILES=src\lib\glad.c src\main.cpp src\GlfwManager.cpp src\Window.cpp src\Scene.cpp src\Shader.cpp src\ShaderProgram.cpp src\ShaderLink.cpp src\BindBuffer.cpp
